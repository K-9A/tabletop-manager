    ...
    <Fragment>
      <div className="container mx-auto p-4">
        ...
        <ul className="list-disc pl-5 mb-4">
          ...
          <li>Basic chat system</li>
          <li>User dashboard</li>
        </ul>
        <p className="text-lg mb-4">
          Up next, work will be done on live updates, sessions, and adding other various features to make the site more robust to follow its original vision.
        </p>
      </div>
    </Fragment>
  );
