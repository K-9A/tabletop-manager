  ...
  return (
    <Fragment>
      <div className="container mx-auto p-4">
        ...
        <p className="text-lg mb-4 dark:text-white">
          Up next work will be done on live sessions, UX improvements, and adding other various features to make the site more robust to follow its original vision.
        </p>
      </div>
    </Fragment>
  );
